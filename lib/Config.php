 ...
 *
 * @package FAC
 * @link http://github.com/future-analytics/future-analytics/public_html/lib/Config.php
...
class Config
{
    ...
    public function __construct(array $params)
    {
    	...
    	foreach($params as $prop => $value)
    	{
    		if (!property_exists($this, $prop))
    			throw new \Exception('FAC Config::setInstance unkown property: '.$prop);
    		else
    			$this->$prop = $value;
    	}
    ...
    public static function getInstance()
    {
    	if(! (self::$instance instanceof self)){
    		throw new \Exception("FAC Config::getInstance singleton instance not constructed");
    	}
